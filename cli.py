...
Generated by: fastmcp generate-cli main.py
"""
...
CLIENT_SPEC = StdioTransport(command='fastmcp', args=['run', 'C:\\Users\\bhara\\MCPServers\\main.py', '--no-banner'])

app = cyclopts.App(name="main", help="CLI for main MCP server")
...
@call_tool_app.command(name='roll_dice')
async def roll_dice(
    *,
    n_dice: Annotated[int, cyclopts.Parameter(help="")] = 1,
) -> None:
    '''Roll n_dice and return the results'''
    await _call_tool('roll_dice', {'n_dice': n_dice})


@call_tool_app.command(name='add_number')
async def add_number(
    *,
    a: Annotated[float, cyclopts.Parameter(help="")],
    b: Annotated[float, cyclopts.Parameter(help="")],
) -> None:
    '''Add two numbers'''
    await _call_tool('add_number', {'a': a, 'b': b})
